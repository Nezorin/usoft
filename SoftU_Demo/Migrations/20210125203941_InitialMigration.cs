        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KafedraId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Kafedras_KafedraId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleItems_AcademicDiscipline_DisciplineId",
                        column: x => x.DisciplineId,
                        principalTable: "AcademicDiscipline",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ScheduleItems_ScheduleDays_ScheduleDayId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Feetback", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Feetback_AspNetUsers_FromId",
                        column: x => x.FromId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Feetback_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feetback_FromId",
                table: "Feetback",
                column: "FromId");

            migrationBuilder.CreateIndex(
                name: "IX_Feetback_StudentId",
                table: "Feetback",
                column: "StudentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduleItems_DisciplineId",
                table: "ScheduleItems",
                column: "DisciplineId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduleItems_ScheduleDayId",
                table: "ScheduleItems",
